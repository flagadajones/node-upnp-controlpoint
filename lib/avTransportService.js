...
var AVTransportService = function (service) {
    ...
    if (this.service) {
        this.service.on(AVTransportService.events.LastChange, function (value) {
            console.log("AVTransportService " + AVTransportService.events.LastChange + " : " + JSON.stringify(value));
        });
