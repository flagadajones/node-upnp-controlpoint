...
//	} 
	...
	if (desc.serviceList) {
		...
		for (var i=0; i<serviceList.length; i++) {
			...
			this._getServiceDesc(serviceDesc, function(service) {
			self.services[serviceDesc.serviceId].initActions(service);
				//console.log(self.services[serviceDesc.serviceId]);
			});
...
UpnpDevice.prototype._getServiceDesc = function(service,callback) {
	var options = {
		host : this.host,
		port : this.port,
