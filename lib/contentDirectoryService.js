...
var ContentDirectoryService = function (service) {
    ...
    //console.log(service);
    if (this.service) {
        this.service.on(EVENT_ContentDirectory_TransferIDs, function (value) {
            if (TRACE && DETAIL) {
        ...
        this.service.on(EVENT_ContentDirectory_SystemUpdateID, function (value) {
            if (TRACE && DETAIL) {
        ...
        this.service.on(EVENT_ContentDirectory_ContainerUpdateIDs, function (value) {
            if (TRACE && DETAIL) {
...
//EVENTS
const EVENT_ContentDirectory_TransferIDs="TransferIDs";
const EVENT_ContentDirectory_SystemUpdateID="SystemUpdateID";
const EVENT_ContentDirectory_ContainerUpdateIDs="ContainerUpdateIDs";
//ACTIONS
//REQUIRED
